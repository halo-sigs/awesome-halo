...
- [plugin-wechat-official-sync](https://github.com/hcjike/plugin-wechat-official-sync) - 一款 [Halo](https://docs.halo.run) 插件：无需离开 Halo 控制台，即可把已写好的文章推送到微信公众号的**草稿箱**，封面与正文图片会自动转存到微信素材库，同步结果实时显示在文章列表。
